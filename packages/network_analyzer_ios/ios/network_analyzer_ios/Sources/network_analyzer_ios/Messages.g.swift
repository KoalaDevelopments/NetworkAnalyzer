...
struct BridgeInfoMessage: Hashable, CustomStringConvertible {
  ...
  static func fromList(_ pigeonVar_list: [Any?]) -> BridgeInfoMessage? {
    let operatingSystem = pigeonVar_list[0] as! String
  ...
  static func == (lhs: BridgeInfoMessage, rhs: BridgeInfoMessage) -> Bool {
    if Swift.type(of: lhs) != Swift.type(of: rhs) {
      return false
    }
    return MessagesPigeonInternal.deepEquals(lhs.operatingSystem, rhs.operatingSystem) && MessagesPigeonInternal.deepEquals(lhs.osVersion, rhs.osVersion)
  }

  func hash(into hasher: inout Hasher) {
    hasher.combine("BridgeInfoMessage")
    MessagesPigeonInternal.deepHash(value: operatingSystem, hasher: &hasher)
    MessagesPigeonInternal.deepHash(value: osVersion, hasher: &hasher)
  }

  public var description: String {
    return "BridgeInfoMessage(operatingSystem: \(String(describing: operatingSystem)), osVersion: \(String(describing: osVersion)))"
  }
}
...
private class MessagesPigeonCodecReader: FlutterStandardReader {
  override func readValue(ofType type: UInt8) -> Any? {
    switch type {
    case 129:
      return BridgeInfoMessage.fromList(self.readValue() as! [Any?])
    default:
...
private class MessagesPigeonCodecWriter: FlutterStandardWriter {
  override func writeValue(_ value: Any) {
    if let value = value as? BridgeInfoMessage {
      super.writeByte(129)
...
protocol NetworkAnalyzerHostApi {
  /// Returns the identity of the native side.
  func getBridgeInfo() throws -> BridgeInfoMessage
}

/// Generated setup class from Pigeon to handle messages through the `binaryMessenger`.
class NetworkAnalyzerHostApiSetup {
  static var codec: FlutterStandardMessageCodec { MessagesPigeonCodec.shared }
  /// Sets up an instance of `NetworkAnalyzerHostApi` to handle messages through the `binaryMessenger`.
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: NetworkAnalyzerHostApi?, messageChannelSuffix: String = "") {
    let channelSuffix = messageChannelSuffix.count > 0 ? ".\(messageChannelSuffix)" : ""
    /// Returns the identity of the native side.
    let getBridgeInfoChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.network_analyzer_ios.NetworkAnalyzerHostApi.getBridgeInfo\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      getBridgeInfoChannel.setMessageHandler { _, reply in
        do {
          let result = try api.getBridgeInfo()
      ...
      getBridgeInfoChannel.setMessageHandler(nil)
    }
  }
}
