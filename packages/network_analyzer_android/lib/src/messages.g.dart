...
class BridgeInfoMessage {
  ...
  static BridgeInfoMessage decode(Object result) {
    result as List<Object?>;
    return BridgeInfoMessage(
      operatingSystem: result[0]! as String,
  ...
  bool operator ==(Object other) {
    if (other is! BridgeInfoMessage || other.runtimeType != runtimeType) {
      return false;
    }
    if (identical(this, other)) {
      return true;
    }
    return _deepEquals(operatingSystem, other.operatingSystem) &&
...
class _PigeonCodec extends StandardMessageCodec {
  ...
  void writeValue(WriteBuffer buffer, Object? value) {
    ...
    } else if (value is BridgeInfoMessage) {
      buffer.putUint8(129);
  ...
  Object? readValueOfType(int type, ReadBuffer buffer) {
    switch (type) {
      case 129:
        return BridgeInfoMessage.decode(readValue(buffer)!);
      default:
...
class NetworkAnalyzerHostApi {
  /// Constructor for [NetworkAnalyzerHostApi]. The [binaryMessenger] named argument is
  ...
  Future<BridgeInfoMessage> getBridgeInfo() async {
    final pigeonVar_channelName =
        'dev.flutter.pigeon.network_analyzer_android.NetworkAnalyzerHostApi.getBridgeInfo$pigeonVar_messageChannelSuffix';
    ...
    return pigeonVar_replyValue! as BridgeInfoMessage;
  }
}
